 ...
 */
public class ReportItensSaidaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            List<NotaFiscal> notaFiscais = notaFiscalService.getNotasFiscaisSaida();
            ...
            params.put("ReportTitle", "Saída de Produtos");
